...
describe('Auth and Profile Routes', () => {
  ...
  describe('POST /register', () => {
    it('should register a new user', async () => {
      ...
      // Clean up
      await db.none('DELETE FROM freelancer WHERE user_id = (SELECT id FROM app_user WHERE email = $1)', ['new@example.com']);
      await db.none('DELETE FROM app_user WHERE email = $1', ['new@example.com']);
    });
